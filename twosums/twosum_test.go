...
func TestTwoSum(t *testing.T) {
	...
	runTestCase(t, []int{4, 2, 3, 1, 5}, 9, []int{0, 4}, "should return 0,4 when given 4,2,3,1,5 and target is 9")
	runTestCase(t, []int{5, 2, 3, 1, 4}, 9, []int{4, 0}, "should return 4,0 when given 5, 2, 3, 1, 4 and target is 9")
	runTestCase(t, []int{2, 2, 7, 1, 4}, 11, []int{4, 2}, "should return 4,2 when given 2, 2, 5, 1, 4 and target is 11")
}
